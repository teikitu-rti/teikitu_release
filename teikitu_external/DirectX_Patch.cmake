...
# SHA 48a762973271c5a75869946bf1fdbc489a628a5c
# Release v1.614.1
...
IF (NOT ${GIT_TAG_LIST} MATCHES "teikitu")
    ...
    GIT_PATCH( "Patch #0001 DirectX C Fixes.patch" "Default to LF.")

    EXECUTE_PROCESS(
        COMMAND ${GIT_EXECUTABLE} rm --cached -r .
        WORKING_DIRECTORY ${WORKING_DIR}
        OUTPUT_VARIABLE GIT_COMMAND_RESULT
        OUTPUT_STRIP_TRAILING_WHITESPACE
    )
    ...
    EXECUTE_PROCESS(
        COMMAND ${GIT_EXECUTABLE} commit -a -u --no-edit -m "Normalize line endings."
        WORKING_DIRECTORY ${WORKING_DIR}
        OUTPUT_VARIABLE GIT_COMMAND_RESULT
        OUTPUT_STRIP_TRAILING_WHITESPACE
    )

    GIT_PATCH( "Patch #0002 DirectX C Fixes.patch" "Fixes for a C compilation.")
