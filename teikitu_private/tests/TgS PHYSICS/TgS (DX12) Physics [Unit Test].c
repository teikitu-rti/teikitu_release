...
TgRESULT tgUnit_Test__PH__Render( TgKN_GPU_CXT_EXEC_ID_C tiCXT_EXEC, TgKN_GPU_CXT_SWAP_ID_C tiCXT_SWAP, TgKN_GPU_CXT_WORK_ID tiCXT_WORK, TgRSIZE_C uiTest_Level )
{
    ...
    #if defined(TgCOMPILE__RENDER_DEBUG_OUTPUT)
    {
        ...
        //s_sModelConstantBuffer.m_avModel_Transform._41 = g_sCamera.m_sConfiguration.m_uCamera_Position.m_vS_F32_04_1.x;
        //s_sModelConstantBuffer.m_avModel_Transform._42 = g_sCamera.m_sConfiguration.m_uCamera_Position.m_vS_F32_04_1.y;
        //s_sModelConstantBuffer.m_avModel_Transform._43 = g_sCamera.m_sConfiguration.m_uCamera_Position.m_vS_F32_04_1.z;
        ...
        s_sModelConstantBuffer.m_avModel_Transform._22 = 0.25F;
        s_sModelConstantBuffer.m_avModel_Transform._33 = 0.25F;
        s_sModelConstantBuffer.m_avModel_Transform._41 = g_sCamera.m_sConfiguration.m_uCamera_Target.m_vS_F32_04_1.x;
        s_sModelConstantBuffer.m_avModel_Transform._42 = g_sCamera.m_sConfiguration.m_uCamera_Target.m_vS_F32_04_1.y;
        s_sModelConstantBuffer.m_avModel_Transform._43 = g_sCamera.m_sConfiguration.m_uCamera_Target.m_vS_F32_04_1.z;
        tgKN_GPU_EXT__CMD__Render_Debug_Geom( psCMD, ETgKN_GPU_DEBUG_PM_3D_SPHERE, &s_sModelConstantBuffer );
    ...
    #if defined(TgCOMPILE__RENDER_DEBUG_OUTPUT)
    {
        ...
        tgPH_Form_Visualize_Render( psCMD, &s_sModelConstantBuffer, tiPH_World, sRTBuffer.m_enFormat, sDSBuffer.m_enFormat );
        PIXEndEvent_ThatWorksInC_ID3D12GraphicsCommandList( uCMD.psEXT->m_psDX12_Graphics_Cmd_List );
    }
    #endif
    ...
    #if defined(TgCOMPILE__RENDER_DEBUG_OUTPUT) && TgCOMPILE__PROFILE
    {
        ...
        tgPH_Debug_Render_Performance_Stats( psCMD, &sRTBuffer );
        PIXEndEvent_ThatWorksInC_ID3D12GraphicsCommandList( uCMD.psEXT->m_psDX12_Graphics_Cmd_List );
    }
    #endif
