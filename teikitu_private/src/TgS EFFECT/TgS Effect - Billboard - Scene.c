...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgFX__Scene__Billboard_Cull__Insert_Frame_Mesh( TgATTRIBUTE_UNUSED STg2_SE_Context_PC psSE_Context, TgATTRIBUTE_UNUSED TgRSIZE_C uiView_Index, TgATTRIBUTE_UNUSED TgFX_DATA_INST_ID tiActive )
{
