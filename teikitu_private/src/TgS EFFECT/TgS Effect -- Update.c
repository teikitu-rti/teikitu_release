...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID T_NAME(tgFX__Update__,_Diag_Check_Effect)( TgATTRIBUTE_UNUSED_PARAM_CHECK TgFX_DATA_INST_ID tiData )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT T_NAME(tgFX__Update__Job__,_Update_Finish)( TgATTRIBUTE_UNUSED STg2_Job_CPC psJob )
{
