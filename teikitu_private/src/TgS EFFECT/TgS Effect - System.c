...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgFX__Client__Collect_Collision_Results( TgATTRIBUTE_UNUSED TgBOOL_C bWait )
{
...
/* ---- tgFX__Update__Group__Update_Command__Process_Command --------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID tgFX__Update__Group__Update_Command__Process_Command( TgATTRIBUTE_UNUSED ETgFX_COMMAND_C enCommand, TgATTRIBUTE_UNUSED TgVOID_CP pData )
{
}
