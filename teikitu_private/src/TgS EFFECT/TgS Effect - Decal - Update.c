...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgBOOL tgFX__Update__Decal_Create_Command( STg2_FX_Instance_CP psInst, TgFX_DATA_INST_ID_C tiData, TgATTRIBUTE_UNUSED TgVOID_CP pData1 )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgFX__Update__Decal_Process_Update_Command( ETgFX_COMMAND_C enCommand, TgATTRIBUTE_UNUSED TgVOID_CP pData, TgFX_DATA_INST_ID_C tiData )
{
#if defined(TgBUILD_FEATURE__GRAPHICS_VFX)
