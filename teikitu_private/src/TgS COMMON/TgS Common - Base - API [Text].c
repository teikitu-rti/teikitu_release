...
/* ---- FCN(To_U32) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_E32 FCN(To_U32)( CHAR(CPC) ARG0, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG0 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
#if defined(GENERATE__WSZ)
...
/* ---- FCN(To_U64) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_E64 FCN(To_U64)( CHAR(CPC) ARG0, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG0 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
#if defined(GENERATE__WSZ)
...
/* ---- FCN(To_S32) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgSINT_E32 FCN(To_S32)( CHAR(CPC) ARG0, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG0 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
#if defined(GENERATE__WSZ)
...
/* ---- FCN(To_S64) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgSINT_E64 FCN(To_S64)( CHAR(CPC) ARG0, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG0 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
#if defined(GENERATE__WSZ)
...
/* ---- FCN(To_F32) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgFLOAT32 FCN(To_F32)( CHAR(CPC) ARG0, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG0 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
#if defined(GENERATE__WSZ)
...
/* ---- FCN(To_F64) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgFLOAT64 FCN(To_F64)( CHAR(CPC) ARG0, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG0 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
#if defined(GENERATE__WSZ)
...
#elif defined(GENERATE__WSZ)
    (void)nbyMaxARG; // Avoid unused variable warning
...
#elif defined(GENERATE__WSZ)
    (void)nbyMaxARG1; // Avoid unused variable warning
...
/* ---- FCN(Copy) ---------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(Copy)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, CHAR(CPC) ARG2, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG2 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
...
/* ---- FCN(Append) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(Append)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, CHAR(CPC) ARG2, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG2 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
    TgPARAM_CHECK(nullptr != ARG2 && nbyMaxARG2 > 0);
...
/* ---- FCN(CopyN) --------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(CopyN)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, CHAR(CPC) ARG2, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG2, TgRSIZE_C ARG4 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
    TgPARAM_CHECK(nullptr != ARG2 && nbyMaxARG2 > 0);
...
/* ---- FCN(AppendN) ------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(AppendN)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, CHAR(CPC) ARG2, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG2, TgRSIZE_C ARG4 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0)
    TgPARAM_CHECK(nullptr != ARG2 && nbyMaxARG2 > 0);
...
#endif
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(Token)( CHAR(PP) szToken, CHAR(PC) ARG, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_P pnbyARG, CHAR(CPC) szDelim, CHAR(PP) szContext )
{
...
/* ---- FCN(StrChr) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(StrChr)( TgRSIZE_P OUT0, CHAR(CPC) ARG1, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C ARG2, CHAR(C) ARG3 )
{
    CHAR(CP)                            pRet;
...
/* ---- FCN(StrStr) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(StrStr)( TgRSIZE_P OUT0, CHAR(CPC) ARG1, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG1, CHAR(CPC) ARG3, TgATTRIBUTE_UNUSED_PARAM_CHECK TgRSIZE_C nbyMaxARG3 )
{
    TgVOID_P                            pRet;
...
TgCLANG_WARN_DISABLE_POP(nonnull)
