...
/*# TgCOMPILE__THREAD */
    ...
    tgUSZ_PrintF(g_uszDefault_Message_Prefix, sizeof(g_uszDefault_Message_Prefix), STD_MSG_PREFIX, TgU8_TEXT_WITH_QUOTE(__MODULE__), u8"Standard Output");
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgS_STAT__COMMON
TgVOID tgGB_Stats( TgATTRIBUTE_UNUSED STg2_Output_P psOutput )
{
    TgSINT_E32                          iIndex;
