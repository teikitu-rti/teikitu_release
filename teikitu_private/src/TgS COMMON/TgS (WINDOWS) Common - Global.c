...
/* ---- tgIDE_DBG_ERR_Write ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRSIZE tgIDE_DBG_ERR_Write( TgATTRIBUTE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP szText, TgRSIZE_C nbyText )
{
...
/* ---- tgIDE_DBG_OUT_Write ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRSIZE tgIDE_DBG_OUT_Write( TgATTRIBUTE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP szText, TgRSIZE_C nbyText )
{
    TgOSCHAR                            szBuffer[1024];
...
/* ---- tgIDE_DBG_ERR_Write ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRSIZE tgIDE_DBG_ERR_Write( TgATTRIBUTE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_UNUSED TgRSIZE_C uiOffset, TgATTRIBUTE_UNUSED TgVOID_CPC mbzText, TgATTRIBUTE_UNUSED TgRSIZE_C nbyText )
{
    return 0;
}
...
/* ---- tgIDE_DBG_OUT_Write ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRSIZE tgIDE_DBG_OUT_Write( TgATTRIBUTE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_UNUSED TgRSIZE_C uiOffset, TgATTRIBUTE_UNUSED TgVOID_CPC mbzText, TgATTRIBUTE_UNUSED TgRSIZE_C nbyText )
{
    return 0;
}
