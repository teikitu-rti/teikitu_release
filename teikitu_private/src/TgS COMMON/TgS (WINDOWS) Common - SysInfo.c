...
/* ---- SI_CO_Print_Configuration ------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID SI_CO_Print_Configuration( TgATTRIBUTE_UNUSED TgUINT_E32_C nuiArg, TgATTRIBUTE_UNUSED TgCHAR_U8_CP pArgV[KTgMAX_CMD_LINE_COUNT] ) TgATTRIBUTE_NO_EXCEPT
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgVOID SI_CO_Print_Modules( TgATTRIBUTE_UNUSED TgUINT_E32_C nuiArg, TgATTRIBUTE_UNUSED TgCHAR_U8_CP pArgV[KTgMAX_CMD_LINE_COUNT] ) TgATTRIBUTE_NO_EXCEPT
{
#if !defined(TgBUILD_UNIVERSAL__UWP)
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgVOID SI_CO_Print_Threads( TgATTRIBUTE_UNUSED TgUINT_E32_C nuiArg, TgATTRIBUTE_UNUSED TgCHAR_U8_CP pArgV[KTgMAX_CMD_LINE_COUNT] ) TgATTRIBUTE_NO_EXCEPT
{
#if !defined(TgBUILD_UNIVERSAL__UWP)
