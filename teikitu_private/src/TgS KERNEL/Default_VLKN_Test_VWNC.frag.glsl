...
//  »File«      Default_VLKN_Test_VWNC.frag.glsl
...
layout(location = 3) in vec4 input_colour;
...
void main()
{
    vec3 final_colour = Apply_Lighting_Unit_Test(input_pos_w.xyz, input_normal.xyz, input_colour.rgb);
    final_colour = HDRCorrection(final_colour);
    output_colour = vec4(final_colour, 1.0);
} 