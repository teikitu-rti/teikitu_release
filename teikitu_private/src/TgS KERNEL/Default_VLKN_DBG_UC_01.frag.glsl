...
//  »File«      Default_VLKN_DBG_UC_01.frag.glsl
...
void main()
{
    vec3 final_colour = pow(abs(input_colour.rgb * DBG_Quad_PUSH.m_vUI_Colour.rgb), vec3(Render_DESC.m_sOutput_DESC.m_fPerceptual_Exponent));
