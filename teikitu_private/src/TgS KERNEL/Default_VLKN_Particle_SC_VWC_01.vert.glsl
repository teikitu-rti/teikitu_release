...
//  »File«      Default_VLKN_Particle_SC_VWC_01.vert.glsl
...
layout(location = 1) in vec4 input_T0;
layout(location = 2) in vec4 input_T1;
layout(location = 3) in vec4 input_uv0_uv1;
layout(location = 4) in vec4 input_colour;
