...
TgRESULT FCN_VO(tgCO_PN_Penetrate_CX)(
    VEC_OBJ_T(STg2_CO_Packet,PC) psPacket, VEC_OBJ_T(TgPLANE,CPC) psPN0, VEC_OBJ_T(TgSTRI,CPC) apsST, TgATTRIBUTE_UNUSED_PARAM_CHECK VEC_OBJ_T(TgBOXAA,CPC) apsBA, TgRSIZE_C nuiTri )
{
