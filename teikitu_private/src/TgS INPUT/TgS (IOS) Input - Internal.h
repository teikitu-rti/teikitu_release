...
#if !defined(TGS_IOS_INPUT_INTERNAL_H)
#define TGS_IOS_INPUT_INTERNAL_H

#include "TgS Input - Internal.h"

#if !defined(TgBUILD_OS__IOS)
#error This file should only be included for IOS platforms
#endif
...
#include "TgS (IOS) Input - Internal - Data.h"
